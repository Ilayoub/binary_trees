...
/**
 * height - The function measures the height of a binary tree
...
/**
 * balance -  The function measures the balance factor of a binary tree
...
/**
 * avl_insert_recursive - The function inserts a value into an AVL tree recursively
...
/**
 * avl_insert - The function inserts a value into an AVL tree
 * @tree: Double pointer to the root node of the AVL tree to insert into
 * @value: Value to insert into the AVL tree
 *
