...
/**
 * is_leaf - The function checks if a node is a leaf of a binary tree
...
/**
 * get_leaf - The function returns a leaf of a binary tree
...
/**
 * is_perfect_recursive - The function checks if a binary
