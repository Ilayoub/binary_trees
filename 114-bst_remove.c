...
/**
 * inorder_successor - The function returns the minimum value of
...
/**
 * bst_delete - Thr function deletes a node from a
 *              binary search tree
...
/**
 * bst_remove_recursive - The function removes a node from a
...
/**
 * bst_remove - The function removes a node from a binary search tree
 * bst_rem: Pointer to the root node of the BST to remove a node from
