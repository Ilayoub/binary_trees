...
/**
 * create_node - The function creates a new levelorder_queue_t node
...
/**
 * free_queue - The function frees a levelorder_queue_t queue
...
/**
 * pint_push - The function runs a function on a given binary tree node
...
/**
 * pop - The function pops the head of a levelorder_queue_t queue
 * @head: The double pointer to the head of the queue
 */
void pop(levelorder_queue_t **head)
{
...
/**
 * binary_tree_levelorder - The function traverses a binary tree
